...
## The Standard Workflow was successfully ran.

The workflow is pretty straightforward.


This test run was useful to identify two things:

- Designing a simulation is mostly setting **parameters** (here through excel files),
- One of the expected result output for the user is graphical: here, a curve showing concentration over time,
...
```{r}
simulatedScenarios$TestScenario
```
