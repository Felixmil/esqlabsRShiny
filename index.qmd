...
## Package Test
First, the package will be tested with a user point of view. Accordingly, the following aspects will be tested:

- Package installation,
- Package usage,

## Package Review
Based on this experience, an in depth analysis will be carried out on:
- user experience,
- data model
